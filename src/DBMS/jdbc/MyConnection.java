...
public class MyConnection implements java.sql.Connection  {
   ...
   private Properties props;
    ...
    public MyConnection(String path,Properties props){
               this.path=path;
               this.props=props;
           }
    @Override
    public Statement createStatement() throws SQLException {
         Statement stm=new MyStatement(path,this);
        if(path==null)
            throw new SQLException("call createStatement on close connection");
        else
           return stm;
      }
